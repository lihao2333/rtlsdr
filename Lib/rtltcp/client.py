...
class RtlSdrTcpClient(RtlSdrTcpBase):
    ...
    def get_mytime(self):
        return self._communicate_descriptor_get('mytime')

    def set_mytime(self, value):
        print("321")
        self._communicate_descriptor_set('mytime', value)
        print("123")
    ...
    mytime = property(get_mytime, set_mytime)
